...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_IT51XXX_CPU_IDLE_GATING, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_TARGET_IT51XXX_MAX_BUF_SIZE, 256);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_IT51XXX_MAX_SHARE_FIFO_SIZE, 256);
